...
| ----------------------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `apiKeys`               | `api-keys`                | API Key definitions assigned to Data Silos. API keys cannot be created through the CLI, but you can map API key usage to Data Silos. | View API Keys                                        | [Developer Tools -> API keys](https://app.transcend.io/infrastructure/api-keys)                                                                                                                                               |
...
| `templates`             | `templates`               | Email templates. Only template titles can be created and mapped to other resources.                                                  | View Email Templates                                 | [DSR Automation -> Email Templates](https://app.transcend.io/privacy-requests/email-templates)                                                                                                                                |
| `dataSilos`             | `data-silos`              | The Data Silo/Integration definitions.                                                                                               | View Data Map, View Data Subject Request Settings    | [Data Inventory -> Data Silos](https://app.transcend.io/data-map/data-inventory/) and [Infrastucture -> Integrations](https://app.transcend.io/infrastructure/integrationsdata-silos)                                         |
...
| `actions`               | `actions`                 | The Privacy Request action settings.                                                                                                 | View Data Subject Request Settings                   | [DSR Automation -> Request Settings](https://app.transcend.io/privacy-requests/settings)                                                                                                                                      |
| `dataSubjects`          | `data-subjects`           | The Privacy Request data subject settings.                                                                                           | View Data Subject Request Settings                   | [DSR Automation -> Request Settings](https://app.transcend.io/privacy-requests/settings)                                                                                                                                      |
...
| `promptPartials`        | `prompt-partials`         | The Transcend AI prompt partials                                                                                                     | View Prompts                                         | [Prompt Manager -> Partials](https://app.transcend.io/prompts/partialss)                                                                                                                                                      |
...
| `agents`                | `agents`                  | The agents in the prompt manager.                                                                                                    | View Pathfinder                                      | [Prompt Manager -> Agents](https://app.transcend.io/prompts/agents)                                                                                                                                                           |
| `agentFunctions`        | `agent-functions`         | The agent functions in the prompt manager.                                                                                           | View Pathfinder                                      | [Prompt Manager -> Agent Functions](https://app.transcend.io/prompts/agent-functions)                                                                                                                                         |
| `agentFiles`            | `agent-files`             | The agent files in the prompt manager.                                                                                               | View Pathfinder                                      | [Prompt Manager -> Agent Files](https://app.transcend.io/prompts/agent-files)                                                                                                                                                 |
...
| `privacyCenters`        | `privacy-center`          | The Privacy Center configurations.                                                                                                   | View Privacy Center Layout                           | [Privacy Center](https://app.transcend.io/privacy-center/general-settings)                                                                                                                                                    |
...
| `templates`             | `templates`               | Email templates. Only template titles can be created and mapped to other resources.                                                  | Manage Email Templates                                   | [DSR Automation -> Email Templates](https://app.transcend.io/privacy-requests/email-templates)                                                                                                                                |
| `dataSilos`             | `data-silos`              | The Data Silo/Integration definitions.                                                                                               | Manage Data Map, Connect Data Silos                      | [Data Inventory -> Data Silos](https://app.transcend.io/data-map/data-inventory/) and [Infrastucture -> Integrations](https://app.transcend.io/infrastructure/integrationsdata-silos)                                         |
...
| `actions`               | `actions`                 | The Privacy Request action settings.                                                                                                 | Manage Data Subject Request Settings                     | [DSR Automation -> Request Settings](https://app.transcend.io/privacy-requests/settings)                                                                                                                                      |
| `dataSubjects`          | `data-subjects`           | The Privacy Request data subject settings.                                                                                           | Manage Data Subject Request Settings                     | [DSR Automation -> Request Settings](https://app.transcend.io/privacy-requests/settings)                                                                                                                                      |
...
| `promptPartials`        | `prompt-partials`         | The Transcend AI prompt partials                                                                                                     | Manage Prompts                                           | [Prompt Manager -> Partials](https://app.transcend.io/prompts/partialss)                                                                                                                                                      |
...
| `agents`                | `agents`                  | The agents in the prompt manager.                                                                                                    | Manage Pathfinder                                        | [Prompt Manager -> Agents](https://app.transcend.io/prompts/agents)                                                                                                                                                           |
| `agentFunctions`        | `agent-functions`         | The agent functions in the prompt manager.                                                                                           | Manage Pathfinder                                        | [Prompt Manager -> Agent Functions](https://app.transcend.io/prompts/agent-functions)                                                                                                                                         |
| `agentFiles`            | `agent-files`             | The agent files in the prompt manager.                                                                                               | Manage Pathfinder                                        | [Prompt Manager -> Agent Files](https://app.transcend.io/prompts/agent-files)                                                                                                                                                 |
...
| `privacyCenters`        | `privacy-center`          | The Privacy Center configurations.                                                                                                   | Manage Privacy Center Layout                             | [Privacy Center](https://app.transcend.io/privacy-center/general-settings)                                                                                                                                                    |
