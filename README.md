...
| file                    | Path to the directory of CSV files to load preferences from                                       | string - file-path | N/A                                          | true     |
| csv                     | false                                                                                             |
...
| receiptFileDir          | Directory path where the response receipts should be saved                                        | string - dir-path  | ./receipts'                                  | false    |
