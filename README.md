...
This command push up a set of identity enrichment results. This is capable of:
...
```sh
yarn tr-manual-enrichment-push-identifiers --auth=$TRANSCEND_API_KEY --sombraAuth=$SOMBRA_INTERNAL_KEY
```
